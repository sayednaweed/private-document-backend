...
class UserController extends Controller
{
    public function users(Request $request, $page)
    {
        ...
        $query = User::with(['contact', 'email', 'job', 'destination']) // Eager load relationships
            ->select("id", "username", "profile", "status", "job_id", "destination_id", 'email_id', 'contact_id', "created_at");
